...
class Tinyerfont : public Print {
  public:
    Tinyerfont(uint8_t *screenBuffer, int16_t width, int16_t height);   //!< Needs to be initialized with a screenBuffer where the height is a multiple of 8.
  ...
  private:
    ...
    int8_t cursorX;    //!< Default is 0.
    int16_t baseX;      //!< needed for linebreak.
    int8_t cursorY;    //!< Default is 0.
